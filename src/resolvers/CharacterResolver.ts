...
export class CharacterResolver {
  ...
  async addCharacter(
    ...
    @Arg('films', () => [String]) films: Array<string>,
    @Arg('species', () => [String]) species: Array<string>,
    @Arg('vehicles', () => [String]) vehicles: Array<string>,
    @Arg('starships', () => [String]) starships: Array<string>,
